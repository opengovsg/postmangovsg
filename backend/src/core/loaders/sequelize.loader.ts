...
import { Credential, JobQueue, Campaign, User, Worker, UserCredential, Statistic } from '@core/models'
...
const sequelizeLoader = async (): Promise<void> => {
  ...
  const coreModels = [Credential, JobQueue, Campaign, User, Worker, UserCredential, Statistic]
