 ...
 * @param model 
 */
const getStatsFromTable = async (campaignId: number, model: any): Promise<{ error: number; unsent: number; sent: number }> => {
 ...
 * @param opsTable
 */
const getCurrentStats = async (campaignId: number, opsTable: any): Promise<CampaignStats> => {
