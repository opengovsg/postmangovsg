  ...
  up: async (queryInterface, _) => {
    await queryInterface.createFunction(
      ...
      `
        ...
        SELECT json_build_object('id', m.id, 'recipient', m.recipient, 'params', m.params, 'paramOrder', t.param_order, 'whatsappTemplateLabel', t.whatsapp_template_label, 'campaignId', m.campaign_id, 'languageCode', m.language_code)
