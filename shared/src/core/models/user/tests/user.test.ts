...
// import { User, Domain, Agency } from '@shared/core/models/index'
...
//     await expect(
//       Agency.findOne({ where: { name: defaultAgencyName } })
//     ).resolves.toBeNull()
//
//     await expect(
//       User.create({
...
//   })
// })
test('This is a placeholder test to fill the file (TEMP)', (): void => {
  return
})
