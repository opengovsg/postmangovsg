...
const reminderEmailBodyGenerator = (
  ...
  switch (whenExpire) {
    ...
    case 'one day':
      ...
      <br><br>
      For more info on how to renew your API key, please refer to our <a href="https://postman-v1.guides.gov.sg/api-guide/api-key-management/rotate-your-api-key">documentation</a>.
      <br><br>
      Thank you,<br>
