...
/*
- This selects API keys that are expiring 28 days, 14 days, 3 days and 1 day from now
- DATE_TRUNC("day", valid_until) function round down the valid_until timestamp to the nearest day
- An email is sent to email addresses associated with the API keys to remind them to renew their API keys
*/
